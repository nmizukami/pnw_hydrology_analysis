...
def base_map(ax, df_cat):
    ax.add_feature(cartopy.feature.OCEAN)
    ax.add_feature(cartopy.feature.LAND, facecolor='white', edgecolor='black')
    ax.add_feature(rivers_10m, facecolor='None', edgecolor='b', alpha=0.2)
    df_cat.plot(ax=ax, facecolor="xkcd:light grey", edgecolor="xkcd:light grey")
